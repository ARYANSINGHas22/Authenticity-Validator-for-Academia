...
//     }}>
//         <h1 style={{ fontSize: "36px", fontWeight: "700", marginBottom: "20px" }}>Why Choose Our Platform?</h1>
//         <p style={{ fontSize: "20px", lineHeight: "1.6", fontWeight: "400" }}>Leading-edge technology meets user-friendly design for the most reliable certificate verification experience.</p>
...
//         maxWidth: "1200px",
//         margin: "40px auto",             // center the row
//         padding: "0 20px",
//       }}
//     >
//       {/* Card 1 */}
...
//         }}
//       >
//         <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: "700" }}>Card 1</h2>
...
//         }}
//       >
//         <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: "700" }}>Card 2</h2>
//         <p style={{ fontFamily: "'Poppins', sans-serif", fontWeight: "400" }}>
...
//         }}
//       >
//         <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: "700" }}>Card 3</h2>
//         <p style={{ fontFamily: "'Poppins', sans-serif", fontWeight: "400" }}>
