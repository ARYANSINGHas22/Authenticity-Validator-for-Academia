      ...
      <header style={{
        ...
        <div style={{
          ...
          <nav style={{
            ...
            <span style={{ fontSize: "16px", fontWeight: "600" }}>Contact</span>
          </nav>
        </div>
      </header>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Have questions about certificate validation? Need enterprise solutions? Our team is 
            here to help you secure academic integrity.
          </p>
        </div>
      </section>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Join hundreds of institutions worldwide in the fight against academic fraud. Our solutions are 
              customized to meet your specific verification needs.
            </p>
          </div>
